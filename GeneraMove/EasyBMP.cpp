...
RGBApixel eBMP::GetPixel( int i, int j ) const
{
 using namespace std;
 bool Warn = false;
 if( i >= Width )
...
bool eBMP::SetPixel( int i, int j, RGBApixel NewPixel )
{
 Pixels[i][j] = NewPixel;
 return true;
}
...
bool eBMP::SetColor( int ColorNumber , RGBApixel NewColor )
{
 using namespace std;
...
// RGBApixel eBMP::GetColor( int ColorNumber ) const
RGBApixel eBMP::GetColor( int ColorNumber )
{ 
 RGBApixel Output;
 Output.Red   = 255;
 Output.Green = 255;
...
// eBMP::BMP( const BMP& Input )
eBMP::eBMP( eBMP& Input )
{
...
RGBApixel* eBMP::operator()(int i, int j)
{
 using namespace std;
 bool Warn = false;
 if( i >= Width )
...
// int eBMP::TellBitDepth( void ) const
int eBMP::TellBitDepth( void )
{ return BitDepth; }

// int eBMP::TellHeight( void ) const
int eBMP::TellHeight( void )
{ return Height; }

// int eBMP::TellWidth( void ) const
int eBMP::TellWidth( void )
{ return Width; }

// int eBMP::TellNumberOfColors( void ) const
int eBMP::TellNumberOfColors( void )
{
...
bool eBMP::SetBitDepth( int NewDepth )
{
 using namespace std;
...
bool eBMP::SetSize(int NewWidth , int NewHeight )
{
 using namespace std;
...
bool eBMP::WriteToFile( const char* FileName )
{
 using namespace std;
...
bool eBMP::ReadFromFile( const char* FileName )
{ 
 using namespace std;
 if( !EasyBMPcheckDataSize() )
 {
...
bool eBMP::CreateStandardColorTable( void )
{
 using namespace std;
 if( BitDepth != 1 && BitDepth != 4 && BitDepth != 8 )
 {
...
void eBMP::SetDPI( int HorizontalDPI, int VerticalDPI )
{
 XPelsPerMeter = (int) ( HorizontalDPI * 39.37007874015748 );
 YPelsPerMeter = (int) (   VerticalDPI * 39.37007874015748 );
}

// int eBMP::TellVerticalDPI( void ) const
int eBMP::TellVerticalDPI( void )
{
 if( !YPelsPerMeter )
...
// int eBMP::TellHorizontalDPI( void ) const
int eBMP::TellHorizontalDPI( void )
{
 if( !XPelsPerMeter )
...
bool eBMP::Read32bitRow( ebmpBYTE* Buffer, int BufferSize, int Row )
{ 
 int i;
...
bool eBMP::Read24bitRow( ebmpBYTE* Buffer, int BufferSize, int Row )
{ 
 int i;
...
bool eBMP::Read8bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row )
{
 int i;
 if( Width > BufferSize )
 { return false; }
...
bool eBMP::Read4bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row )
{
 int Shifts[2] = {4  ,0 };
 int Masks[2]  = {240,15};
...
bool eBMP::Read1bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row )
{
...
bool eBMP::Write32bitRow( ebmpBYTE* Buffer, int BufferSize, int Row )
{ 
 int i;
 if( Width*4 > BufferSize )
 { return false; }
...
bool eBMP::Write24bitRow( ebmpBYTE* Buffer, int BufferSize, int Row )
{ 
 int i;
 if( Width*3 > BufferSize )
 { return false; }
...
bool eBMP::Write8bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row )
{
 int i;
 if( Width > BufferSize )
 { return false; }
...
bool eBMP::Write4bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row )
{ 
...
bool eBMP::Write1bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row )
{ 
...
ebmpBYTE eBMP::FindClosestColor( RGBApixel& input )
{
 using namespace std;
